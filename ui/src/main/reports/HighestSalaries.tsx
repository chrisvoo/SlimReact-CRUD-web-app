...
export const HighestSalaries = () => {
  ...
  useEffect(() => {
    ...
    axios.get<ReportResponse[]>('/api/report/highest_salaries')
      .then((result) => {
  ...
  return (
    <Card>
      <Card.Header>Highest Salaries</Card.Header>
      <Card.Body>
        <Card.Text>
          This report shows all departments along with the highest salary within each department.
